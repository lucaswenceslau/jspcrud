	        ...
	        <div class="span3">
	          <div class="well sidebar-nav">
	            <ul class="nav nav-list">
	              ...
	              <li><a href="http://localhost:8080/ToyTech/ServletProduto?cmd=listarCategoria&idCategoria=2">Pel�cias</a></li>
	         ...
	         <div class="container-fluid">	
	          	...
	          	<form action="ServletProduto" method="get">
					 ...
					 <tbody>
						 ...
						 <tr>
						 	<th><h4>Id do Produto</h4></th>
						 <td>
						 	<input type="text" name=idProduto size="10" maxlenght="10" />
						 </td>
						 	<th><h4>Nome do Produto</h4></th>
						 <td>
						 	<input type="text" name="nomeProduto" size="10" maxlenght="10" />
						 </td>
						 	<th><h4>Categoria do Produto</h4></th>
						 <td>
						 	<input type="text" name="idCategoria" size="10" maxlenght="10" />
						 </td>
						 	<th><h4>Pre�o do Produto</h4></th>
						 <td>
						 	<input type="text" name="precoUnitario" size="10" maxlenght="10" />
						 </td>
						  	<th><h4>Imagem URL</h4></th>
						 <td>
						 	<input type="text" name="imgProduto" size="10" maxlenght="10" />
						 </td>
						 	<th><h4>Descri��o do Produto</h4></th>
						 <td>
						 	<input type="textarea" name="descricao" size="10" maxlenght="10" style="width: 400px; height: 150px;"/>
						 </td>
						 </tr>
						 <tr>
